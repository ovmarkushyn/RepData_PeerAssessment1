...
```
In case NA are replaced with values mean is `r sprintf( "%.2f", nafilldaystepsmean )` and median is `r sprintf( "%.2f", nafilldaystepsmedian )` but in first case mean was `r sprintf( "%.2f", daystepsmean )` and median was `r sprintf( "%.2f", daystepsmedian )`
